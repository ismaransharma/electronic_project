@extends('layouts.template', ['activePage' => ''])
                ...
                <div class="top-header-laptop-category">
                    <div class="laptop-category-all-in-one top-header-category">
                        <a href="{{ url('/laptop-category')}}">
                            <h5 class="latop-category">All in One</h5>
                        </a>
                    </div>
                    ...
                    <div class="laptop-category-budget-laptop top-header-category">
                        <a href="{{ url('/category-budget-laptop')}}">
                            <h5 class="latop-category active">Budget Laptop</h5>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="product-box">
                            <div class="product-image">
                                <div class="product-main-image">
                                    <img src="{{ asset('site/images/category-images/dell-inspiron-3511-budget-laptop.png')}}"
                                        alt="">
                                </div>
