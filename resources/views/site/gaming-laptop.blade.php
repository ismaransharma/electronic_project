        ...
        <div class="top-header-laptop-category-padding">
            <div class="top-header-laptop-category">
                ...
                <div class="laptop-category-gaming-laptop top-header-category">
                    <a href="{{ url('/categroy-gaming-laptop')}}"><h5 class="latop-category active">Gaming Laptop</h5></a>
                </div>
                <div class="laptop-category-budget-laptop top-header-category">
                    <a href="{{ url('/category-budget-laptop')}}"><h5 class="latop-category">Budget Laptop</h5></a>
                </div>
            </div>
        </div>
        <div class="top-sale">
                    ...
                    <div class="product-box">
                        <div class="product-image">
                            <div class="product-main-image">
                                <img src="{{ asset('site/images/category-images/asus-rog-strix-g15-gaming-laptop.png')}}" alt="">
                            </div>
                        ...
                        <div class="product-details">
                            <div class="product-name">
                                <span class="product-name-title">ASUS ROG G15 Gaming Laptop</span>
